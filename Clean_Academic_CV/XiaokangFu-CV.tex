...
\DeclareFieldFormat[article]{volume}{#1} % Removes bold formatting for volume
...
\mytitle{Xiaokang Fu}{fxk123@gmail.com}{wybert.github.io}{Github stars 250; Google Scholar citations 1020} % Insert your custom title
...
\vspace{-.75em}
\small
\faGoogle~\href{https://scholar.google.com.hk/citations?user=H9RAbHIAAAAJ}{Google Scholar}\\
$\dagger \rightarrow$ Equal contribution
\normalsize

\subsection*{Selected Papers}
\label{select-paper}
\newrefcontext[labelprefix=S] % Will prefix biblioøgraphy numbers with this letter
...
\printbibliography[
    ...
    keyword=S % Include items in ref.bib with keyword={J}
]
...
% other joined projects
% 国家重点研发计划 2016YFB0501403 典型地形要素自动识别与快速提取技术  国家测绘地理信息局卫星测绘应用中心 总预算 2085.00 万元，其中中央财政专项经费 2085.00 万元 起始时间 2016年07月 结束时间 2021年06月 武汉大学 参与单位 专项经费270万
...
% FIXME: Add all the reviewed paper
